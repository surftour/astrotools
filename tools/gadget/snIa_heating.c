...
void snIa_heating(void)
{
  ...
  do
      ...
      for(j = 0, nimport = 0, Recv_offset[0] = 0, Send_offset[0] = 0; j < NTask; j++)
	{
      ...
      SnheatingdataGet = (struct snheatingdata_in *) mymalloc(nimport * sizeof(struct snheatingdata_in));
      SnheatingdataIn = (struct snheatingdata_in *) mymalloc(nexport * sizeof(struct snheatingdata_in));
