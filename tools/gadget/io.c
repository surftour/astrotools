	...
	if(P[pindex].Type == type)
	  {
	    ...
	    *fp++ =
	      (MyOutputFloat) P[pindex].init_density / (All.TimeBegin * All.TimeBegin * All.TimeBegin) *
	      P[pindex].annihilation;
#else
...
int get_particles_in_block(enum iofields blocknr, int *typelist)
{
  ...
  switch (blocknr)
    ...
    case IO_AGE:
     /* If the values in the age array for the disk and bulge
         particles are valid, we save them too. */
      typelist[0]=0;
      typelist[1]=0;
      typelist[5]=0;
      return nstars+header.npart[2]+header.npart[3];
      break;
...
*/
    ...
    case IO_Z:
      /* If the values in the metallicity array for the disk and bulge
         particles are valid, we save them too. */
      typelist[1]=0;
      typelist[5]=0;
      return ngas+nstars+header.npart[2]+header.npart[3];
      break;
