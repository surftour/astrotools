...
#define MAXTAGS 300
  ...
  strcpy(tag[nt], "DiskPopMode");
  addr[nt] = &DiskPopMode;
  id[nt++] = STRING;

  strcpy(tag[nt], "DiskPopAge");
  addr[nt] = &DiskPopAge;
  id[nt++] = FLOAT;

  strcpy(tag[nt], "DiskPopTau");
  addr[nt] = &DiskPopTau;
  id[nt++] = FLOAT;
  ...
  strcpy(tag[nt], "BulgePopMode");
  addr[nt] = &BulgePopMode;
  id[nt++] = STRING;

  strcpy(tag[nt], "BulgePopAge");
  addr[nt] = &BulgePopAge;
  id[nt++] = FLOAT;

  strcpy(tag[nt], "BulgePopTau");
  addr[nt] = &BulgePopTau;
  id[nt++] = FLOAT;
  ...
  strcpy(tag[nt], "AnisotropyRadius");
  addr[nt] = &AnisotropyRadius;
  id[nt++] = FLOAT;
...
/* break */
  ...
  strcpy(tag[nt], "GravSoftening");
  addr[nt] = &GravSoftening;
  id[nt++] = FLOAT; 
  ...
  addr[nt] = &WriteDensity;
  id[nt++] = INT;  

  strcpy(tag[nt], "UseQrng");
  addr[nt] = &UseQrng;
  id[nt++] = INT;  
