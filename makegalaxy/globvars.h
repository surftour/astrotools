...
#define  HUBBLE      0.7     /* Hubble constant in 100km/sec/Mpc */  
			     /* note that this effectively takes the
                                h^-1 factor out of all units */
...
extern char DiskPopMode[50]; 
extern double  DiskPopAge; 
extern double  DiskPopTau; 
extern double  BulgeSize;
extern char BulgePopMode[50]; 
extern double  BulgePopAge; 
extern double  BulgePopTau; 
...
extern double  AnisotropyRadius; /* specifies the anisotropy radius, in units of RH */

extern int     GasDistribution;
extern double  GasExpAlpha;
extern double  rb;
extern double  PowerLawGamma;
extern double  PowerLawCutoff;
extern double  Zmet0;           /* gas metallicity central value (in metal fraction) */
extern double  ZmetGrad;        /* gas metallicity gradient (in dex/kpc) */



extern double GravSoftening;     /* used for the force calculation */
extern int WriteDensity;
extern int UseQrng; /* Use quasi-random generators instead of pseudorandom. */
...
extern double  M200;     /* virial mass (in 10^10 M_solar) */

extern double  RH;       /* scale radius in Hernquist profile (in kpc) */

extern double  RS;       /* scale radius for halo (in kpc) */
extern double  R200;     /* virial radius (in kpc) */
extern double  H;        /* disk scale length (in kpc) */
extern double  Z0;       /* disk thickness (in kpc) */
extern double  A;        /* bulge scale radius (in kpc) */

extern int N_TOTAL;      /* total number of particle */
...
extern double    *xp_gas,*yp_gas,*zp_gas,*mp_gas,*rho_gas,*u_gas;
...
extern double **phi;                         /* total potential */
extern double PhiMin;                         /* potential minimum */
...
extern double *list_z,*list_R,*list_RplusdR,*list_RminusdR;
