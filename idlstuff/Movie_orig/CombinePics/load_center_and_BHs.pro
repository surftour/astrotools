...
pro load_center_and_BHs, fname, bhlist, time, center, nbh, idbh, mbh, posbh
...
center=fltarr(3)
;center[0]=total(pos[0,*]*mass[*])/total(mass)
;center[1]=total(pos[1,*]*mass[*])/total(mass)
;center[2]=total(pos[2,*]*mass[*])/total(mass)
...
if c gt 0 then begin
    center[0]=total(pos[0, w]*mass[w])/total(mass[w])
    center[1]=total(pos[1, w]*mass[w])/total(mass[w])
    center[2]=total(pos[2, w]*mass[w])/total(mass[w])
endif
   
print, 'gal center= ', center
