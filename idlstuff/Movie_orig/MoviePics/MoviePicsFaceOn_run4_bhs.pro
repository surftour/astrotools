...
;            f=PicsDir +"jpeg/pic_gas_"+halost[ih]+"_"+exts+".jpg"
            f=PicsDir +"figure/pic_gas_"+halost[ih]+"_"+exts+".jpg"
            f=strcompress(f,/remove_all)
;            fps=PicsDir +"eps/pic_gas_"+halost[ih]+"_"+exts+".eps"
            fps=PicsDir +"figure/pic_gas_"+halost[ih]+"_"+exts+".eps"
...
;            !p.position=[0.0, 0.0, 0.0+20*4.0/3.0, 0.0+20.0]
            ...
            oploterror, [-30], [-30], [10], [0], psym=sym(3), symsize=0.1, thick=6, $
              col=200, errcol=200

            xyouts, [-30], [-27], '20 kpc h!U-1!N', charsize=2, charthick=5, col=200
            xyouts, [-30], [-33], '3!U"!N.6', charsize=2, charthick=5, col=200
