...
;
;
;    Gas Consumption Timescale (SFR / Gas Mass)
;
;
;
;==============================================================
...
if not keyword_set(junk) then begin
   print, "  "
   print, "gct, junk, filename=filename, /h"
   print, "  "
   print, "  "
   return
endif
...
yaxistitle="!5SFR / Gas Mass (0.1 Gyr!E-1!N) "
...
;stop
	...
	for i=0,ifinal do begin
	    ; get sfr data
	    sfrfile= '/home/tcox/upsand/sfr/'+fload_getid(fruns[i])+'.sfr'
...
;endif
	    ...
	    print, "-------------------------------------"
            ...
            if keyword_set(cumulative) then begin
                ...
                oplot, sfrtime, sfrsfr/sfrgasmass, psym=-3, color= zcolor, linestyle= lstyle, thick= thickstyle
            endelse
