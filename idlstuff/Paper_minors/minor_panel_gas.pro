pro produce_one_image, frun, snapnum, xlen, sendto, $
			...
			ReturnTimeLbl= ReturnTimeLbl, edgeon=edgeon
...
if keyword_set(edgeon) then begin
	tempvar= y
	y= z
	z= tempvar
endif
...
contour_makepic, x, y, z, m, xlen, xz=xz, yz=yz, $
	...
	ReturnTimeLbl= fload_timelbl(1.0,2,/noteq)
; -------------
;  Done
; -------------
...
;frun= "/raid2/tcox/G3/G3Rd4eG1_n0"
;filename='min_panelgas_g3g1_what.eps'
filename='min_panelgas_g3g1.eps'
;;snaparr= [20, 22, 26, 40, 60, 66, 72, 76, 80, 90, 100, 120]
snaparr= [20, 22, 26, 40, 60, 66, 72, 76, 80, 100, 120, 120]
xlenarr(*)= 100.0
;-----------
;msg='G3G2'
;frun= "/raid12/tcox/Gs/G3G2-u4"
;filename='min_panelgas_g3g2.eps'
;snaparr= [18, 24, 32, 40, 44, 48, 52, 60, 80, 100, 120, 120]
;xlenarr(*)= 100.0
;-----------
...
;--------------------------------------
	...
	do_panel, frun, snaparr[0], xlenarr[0], x0, y3, xs, ys, $
		rotate_phi=rotate_phi, rotate_theta=rotate_theta, /colorbar, /drawtrack
	do_panel, frun, snaparr[1], xlenarr[1], x1, y3, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, /drawtrack
	do_panel, frun, snaparr[2], xlenarr[2], x2, y3, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, /drawtrack
	do_panel, frun, snaparr[3], xlenarr[3], x0, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, /drawtrack
	do_panel, frun, snaparr[4], xlenarr[4], x1, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, /drawtrack
	do_panel, frun, snaparr[5], xlenarr[5], x2, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, /drawtrack
	do_panel, frun, snaparr[6], xlenarr[6], x0, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, /drawtrack
	do_panel, frun, snaparr[7], xlenarr[7], x1, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, /drawtrack
	...
	do_panel, frun, snaparr[11], xlenarr[11], x2, y0, xs, ys, $
		rotate_phi=rotate_phi, rotate_theta=rotate_theta, /edgeon
	...
	; -----------
		...
		xyouts, x0+0.02, y4-0.07, msg, /normal, size= 1.7, charthick=5.0, color= 0   ; 0=black, 1=white
        	xyouts, x0+0.08, y4-0.03, '!6Gyr', /normal, size= 1.2, charthick=2.0, color= 0
        endif
...
pro do_panel, frun, snapnum, xlen, $
	...
	edgeon=edgeon, drawtrack=drawtrack
	...
	if keyword_set(edgeon) then xyouts, x0+0.02, y1-0.06, 'side view', /normal, size= 1.2, charthick=2.0, color= 0
	...
	;snaplbl= '('+strcompress(string(snapnum),/remove_all)+')'
		...
		;  tracktodraw
                ; -----------------------------
		if keyword_set(drawtrack) then drawcenters= 1 else drawcenters= 0
		if keyword_set(drawcenters) then begin
			...
			oplot, cp_cen2_x, cp_cen2_y, psym=-3, linestyle=1, color= 0, thick=4.0
...
pro overplot_axes, xx0, yy0, xx1, yy1, thetimelbl, xlen, $
	...
	ymax=  xlen
        ...
        xyouts, xx0+0.02, yy1-0.03, '!6'+thetimelbl, /normal, size= 1.2, charthick=2.0, color= 0
