...
setup_plot_stuff, sendto, filename=filename, colortable= 4,  newxsize=10, newysize=16
...
;lbls= ['!61x (!8n2med!6)', '!62x', '!64x', '!610x', '!610x, !8h!6=0.047']    ; paper version
...
;lbls= ["!6entropy (!8n2low!6)","!6energy, standard","!6energy, geometric","!6energy, asymmetric","!6entropy, standard"]
; change order
;fruns= ["Sbc201a-u4c", "Sbc201a-u4d", "Sbc201a-u4u","Sbc201a-u4v", "Sbc201a-u4"]
;lbls= ["!6energy, geometric","!6energy, standard","!6energy, asymmetric","!6entropy, standard","!6entropy (!8n2med!6)"]
...
;        lbls= ["!6c!I* !N=0.3","!6  !I !N 0.06","!6  !I !N 0.03 (!8n2med!6)","!6  !I !N 0.015","!6  !I !N 0.004"]
...
;lbls= ['!60 (!8n2med!6)','!610!E-3!N','!610!E-2!N','!610!E-1.5!N','!610!E-1!N','1']  ; - paper version
...
for i=0,ifinal do begin
	...
	process_one_sfrfile, fruns[i], $
			lstyle=lstyle, zcolor=zcolor
...
for i=0,ifinal do begin
        ...
        process_one_sfrfile, fruns[i], /cumulative, $
                        lstyle=lstyle, zcolor=zcolor
...
if std eq 1 then begin
	...
	if n_elements(lbls) gt 0 then begin
                ;xyouts, x0, y0, lbls[i], /normal, charthick=4.0, size=1.20, color=zcolor
                xyouts, x0, y0, lbls[i], /normal, charthick=4.0, size=1.50, color=zcolor
                    zcolor= zcolor+deltacolor
	endif else begin
		xyouts, x0, y0, fruns[i], /normal, charthick=4.0, size=1.33, color=zcolor
	            zcolor= zcolor+deltacolor
	endelse
    endfor
endif
...
pro process_one_sfrfile, frun, cumulative=cumulative, $
			lstyle=lstyle, zcolor=zcolor
