      subroutine emissivity(ebin,etin,zrin,rmin,tdegkin,edin,rnhin,r)
      common/eparms/ebot,etop,zred,rmet,tempdegk,eden
      real*8 totpow,rnh,r
      real*8 ebin,etin,zrin,rmin,tdegkin,edin,rnhin
...
c      print *,'zred ',zred
c      print *,'rmet ',rmet
c      print *,'tempdegk ',tempdegk
c      print *,'eden ',eden
c      print *,'rnh ',rnh
c
c     print *,'what is the energy band (bottom, top, in eV)?'
c     print *,'(this is the observed band)'
c     read *,ebot,etop
c
      if (etop.lt.100.) then
c        print *,'please please please enter it in eV'
         stop
         endif
c
c     print *,'what is the redshift?'
c     read *,zred
c 
c     print *,'what is the metallicity in units of solar (e.g. 0.1)?'
c     read *,rmet
c
c     print *,'what is the temperature in degrees K?'
c     read *,tempdegk
c
c     print *,'what is the number of electrons per cm^-3?'
c     read *,eden
c
      call xspct(totpow)
c
...
c
      totpow4=totpow*rnh
c
c     print *,'total power in erg s^-1 cm^-3 is ',totpow4
      r = totpow4
c
      return
      end
...
c
      ...
      close(7)
c
c  brant had me add the following to
c  solve the metallicity problem.
c
      do i=2,12,1  ! keep He the same
         abunj(i)=abunj(i)-alog10(rmet)
         enddo
