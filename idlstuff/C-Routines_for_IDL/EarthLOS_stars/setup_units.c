...
/* Sets the units and constants used by the "All.xxxxx" variables throughout */
  ...
  All.MaxSfrTimescale	= STAR_FORMATION_TIMESCALE_IN_GYR;
  ...
  All.Hubble          = 1.0e7 / CM_PER_MPC * All.UnitTime_in_s;
...
void init_clouds(void)
{
  ...
  if(All.PhysDensThresh == 0)
	...
	//printf("dens %e Hubble %e M_PI %e G %e\n",dens,All.Hubble,M_PI,All.G); /* machine value of Pi */
      ...
      if(All.ComovingIntegrationOn)
	{
      ...
      // printf("A0, egyhot, dens, u4, ne, tcool, All.FactorSN, All.EgySpecSN, All.EgySpecCold \n %e  %e  %e %e  %e  %e  %e %e %e \n",A0, egyhot, dens, u4, ne, tcool, All.FactorSN, All.EgySpecSN, All.EgySpecCold);
