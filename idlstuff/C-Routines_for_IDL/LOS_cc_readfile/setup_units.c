...
/* Sets the units and constants used by the "All.xxxxx" variables throughout */
  ...
  All.HubbleParam     = 0.7; //header.HubbleParam;		// Defined by readsnap.c when reading in snapshots
  All.Hubble          = 1.0e7 / CM_PER_MPC * All.UnitTime_in_s; //* All.HubbleParam
  All.ComovingIntegrationOn = 0;	// Turn off comoving integration terms
  
  /* set the rest of the units and Paul's versions of the CGS units */
  set_units_sfr();
