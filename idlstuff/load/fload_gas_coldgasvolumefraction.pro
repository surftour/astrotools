function fload_gas_coldgasvolumefraction, dummy, idtofollow=idtofollow, $
    ...
    ; convert to volume_cold / volume_total
    if dummy EQ 1 then return, cold_volume_div_totalV= volume_filling_factor / (1.0 + volume_filling_factor)


    ;--------------------------------
    ;if dummy EQ 1 then return, cold_volume_fraction
