...
make_cummass_file, "yuexing", 2, xmin, xmax, bins
make_cummass_file, "yuexing", 3, xmin, xmax, bins
make_cummass_file, "yuexing", 4, xmin, xmax, bins
make_cummass_file, "yuexing", 5, xmin, xmax, bins
make_cummass_file, "yuexing", 6, xmin, xmax, bins
make_cummass_file, "yuexing", 7, xmin, xmax, bins
make_cummass_file, "yuexing", 8, xmin, xmax, bins
make_cummass_file, "yuexing", 9, xmin, xmax, bins
make_cummass_file, "yuexing", 10, xmin, xmax, bins
make_cummass_file, "yuexing", 11, xmin, xmax, bins
make_cummass_file, "yuexing", 12, xmin, xmax, bins
make_cummass_file, "yuexing", 13, xmin, xmax, bins
make_cummass_file, "yuexing", 14, xmin, xmax, bins
make_cummass_file, "yuexing", 15, xmin, xmax, bins
make_cummass_file, "yuexing", 16, xmin, xmax, bins
make_cummass_file, "yuexing", 17, xmin, xmax, bins
make_cummass_file, "yuexing", 18, xmin, xmax, bins
...
pro make_cummass_file, frun, snapnum, xmin, xmax, bins, $
					center=center, xlog=xlog, filename=filename
