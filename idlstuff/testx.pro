...
print, "L_x= ",total(xray)
	...
	ReturnImage= NxNImage
	print, "What's the X-ray image all about?"
	Help, ReturnImage
...
;snap4= 31
;snap5= 71
;snap6= 107  & center6= [-7.1,-12.2,3.2]

; new version (without BH)
...
;snap4= 31
;snap5= 71
;snap6= 107  & center6= [-8.1,-2.5,1.4]

frun= "/raid1/sbush/antennae/firstgasrun/"
msg='what is this?'
snap1= 10
snap2= 25
snap3= 30
...
produce_xray_image, frun, snap1, xlen, xz=xz, yz=yz, /loadedsnap, $
	xthickness=xthickness, ythickness=ythickness, zthickness=zthickness, $
	pixels=pixels, rotate_phi=rotate_phi, rotate_theta=rotate_theta, $
...
produce_xray_image, frun, snap2, xlen, xz=xz, yz=yz, /loadedsnap, $
	xthickness=xthickness, ythickness=ythickness, zthickness=zthickness, $
	pixels=pixels, rotate_phi=rotate_phi, rotate_theta=rotate_theta, $
	crude=crude, center=center, ReturnImage=ReturnImage
...
produce_xray_image, frun, snap3, xlen, xz=xz, yz=yz, /loadedsnap, $
        xthickness=xthickness, ythickness=ythickness, zthickness=zthickness, $
        pixels=pixels, rotate_phi=rotate_phi, rotate_theta=rotate_theta, $
        crude=crude, center=center, ReturnImage=ReturnImage

XrayPic3= ReturnImage
...
produce_xray_image, frun, snap4, xlen, xz=xz, yz=yz, /loadedsnap, $
	xthickness=xthickness, ythickness=ythickness, zthickness=zthickness, $
	pixels=pixels, rotate_phi=rotate_phi, rotate_theta=rotate_theta, $
	crude=crude, center=center, ReturnImage=ReturnImage

XrayPic4= ReturnImage
...
produce_xray_image, frun, snap5, xlen, xz=xz, yz=yz, /loadedsnap, $
        xthickness=xthickness, ythickness=ythickness, zthickness=zthickness, $
        pixels=pixels, rotate_phi=rotate_phi, rotate_theta=rotate_theta, $
        crude=crude, center=center, ReturnImage=ReturnImage

XrayPic5= ReturnImage
...
produce_xray_image, frun, snap6, xlen, xz=xz, yz=yz, /loadedsnap, $
	xthickness=xthickness, ythickness=ythickness, zthickness=zthickness, $
	pixels=pixels, rotate_phi=rotate_phi, rotate_theta=rotate_theta, $
	crude=crude, center=center, ReturnImage=ReturnImage

XrayPic6= ReturnImage
...
; -------------------------------------
	...
	;setup_plot_stuff, sendto, filename=filename, colortable= 4
        ...
        ;setup_plot_stuff, sendto, filename=filename, colortable= 0, newxsize=10, newysize=10
	...
	; ----------------------
	tv, Pic1, x0, y1, xsize=xs, ysize=ys, /normal
	tv, Pic2, x1, y1, xsize=xs, ysize=ys, /normal
	tv, Pic3, x2, y1, xsize=xs, ysize=ys, /normal
	tv, Pic4, x0, y0, xsize=xs, ysize=ys, /normal
	tv, Pic5, x1, y0, xsize=xs, ysize=ys, /normal
	tv, Pic6, x2, y0, xsize=xs, ysize=ys, /normal
	...
	overplot_axes, x1, y1, x2, y2, TimeLbl2, xlen
	overplot_axes, x2, y1, x3, y2, TimeLbl3, xlen

	;  second row
	; -------------
	overplot_axes, x0, y0, x1, y1, TimeLbl4, xlen
	overplot_axes, x1, y0, x2, y1, TimeLbl5, xlen
	overplot_axes, x2, y0, x3, y1, TimeLbl6, xlen
	...
	overplot_xraycontour, XrayPic1, x0, y1, x1, y2, xlen
	overplot_xraycontour, XrayPic2, x1, y1, x2, y2, xlen
	overplot_xraycontour, XrayPic3, x2, y1, x3, y2, xlen
	overplot_xraycontour, XrayPic4, x0, y0, x1, y1, xlen
	overplot_xraycontour, XrayPic5, x1, y0, x2, y1, xlen
	overplot_xraycontour, XrayPic6, x2, y0, x3, y1, xlen



	; print msg
	; -----------
	xyouts, 0.03, 0.88, msg, /normal, size= 1.5, charthick=3.0, color= 0   ; 0=black, 1=white
...
pro overplot_newstars, frun, snapnum, x0, y0, x1, y1, xlen, xmin, xmax, ymin, ymax, $
	...
	; --------------------------------
	if not keyword_set(loadedsnap) then begin
	   if (fload_snapshot(frun, snapnum, /nopot_in_snap)) then begin
	...
	ymin=-xlen
		...
		help, imagemap
                ...
                for i=0, (n_elements(info)-1) do begin
                        ...
                        xycnt= xy_contours(*,info(i).offset+cnt_index)
                        n_level= info(i).level
                        xycnt[0,*]= xycnt[0,*]*(x1-x0)/120.0 + x0
                        xycnt[1,*]= xycnt[1,*]*(y1-y0)/120.0 + y0
                        ;if n_level eq 0 then plots, xycnt, /normal, color= 150, thick=4.0
                        ;if n_level eq 1 then plots, xycnt, /normal, color= 150, thick=2.0
                        ;if n_level eq 2 then plots, xycnt, /normal, color= 150, linestyle= 1
                        ;if n_level eq 3 then plots, xycnt, /normal, color= 130, linestyle= 1
...
pro overplot_axes, xx0, yy0, xx1, yy1, thetimelbl, xlen, $
	...
	ymax=  xlen
        ...
        xyouts, xx0+0.04, yy1-0.06, thetimelbl, /normal, size= 1.6, charthick=4.0, color= 0
