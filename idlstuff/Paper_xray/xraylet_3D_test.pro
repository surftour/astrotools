...
processandplot_onedensityprofile, "/raid4/tcox/gfs/vc3vc3u_k", snapnum1, xmin, xmax, bins, linecolor= 200, /xrwt
processandplot_onedensityprofile, "/raid4/tcox/gfs/vc3vc3v_k", snapnum2, xmin, xmax, bins, linecolor= 170, /xrwt
processandplot_onedensityprofile, "/raid4/tcox/gfs/vc3vc3w_k", snapnum1, xmin, xmax, bins, linecolor= 140, /xrwt
processandplot_onedensityprofile, "/raid4/tcox/gfs/vc3vc3x2_k", snapnum2, xmin, xmax, bins, linecolor= 110, /xrwt
processandplot_onedensityprofile, "/raid4/tcox/gfs/vc3vc3y_k", snapnum1, xmin, xmax, bins, linecolor= 80, /xrwt
processandplot_onedensityprofile, "/raid4/tcox/gfs/vc3vc3z_k", snapnum2, xmin, xmax, bins, linecolor= 50, /xrwt
...
processandplot_onetcoolprofile, "/raid4/tcox/gfs/vc3vc3u_k", snapnum1, xmin, xmax, bins, linecolor= 200, /xrwt, Metallicity='-15'
processandplot_onetcoolprofile, "/raid4/tcox/gfs/vc3vc3v_k", snapnum2, xmin, xmax, bins, linecolor= 170, /xrwt, Metallicity='-15'
processandplot_onetcoolprofile, "/raid4/tcox/gfs/vc3vc3w_k", snapnum1, xmin, xmax, bins, linecolor= 140, /xrwt, Metallicity='-15'
processandplot_onetcoolprofile, "/raid4/tcox/gfs/vc3vc3x2_k", snapnum2, xmin, xmax, bins, linecolor= 110, /xrwt, Metallicity='-15'
processandplot_onetcoolprofile, "/raid4/tcox/gfs/vc3vc3y_k", snapnum1, xmin, xmax, bins, linecolor= 80, /xrwt, Metallicity='-15'
processandplot_onetcoolprofile, "/raid4/tcox/gfs/vc3vc3z_k", snapnum2, xmin, xmax, bins, linecolor= 50, /xrwt, Metallicity='-15'
...
processandplot_oneentropyprofile, "/raid4/tcox/gfs/vc3vc3u_k", snapnum1, xmin, xmax, bins, linecolor= 200, /xrwt
processandplot_oneentropyprofile, "/raid4/tcox/gfs/vc3vc3v_k", snapnum2, xmin, xmax, bins, linecolor= 170, /xrwt
processandplot_oneentropyprofile, "/raid4/tcox/gfs/vc3vc3w_k", snapnum1, xmin, xmax, bins, linecolor= 140, /xrwt
processandplot_oneentropyprofile, "/raid4/tcox/gfs/vc3vc3x2_k", snapnum2, xmin, xmax, bins, linecolor= 110, /xrwt
processandplot_oneentropyprofile, "/raid4/tcox/gfs/vc3vc3y_k", snapnum1, xmin, xmax, bins, linecolor= 80, /xrwt
processandplot_oneentropyprofile, "/raid4/tcox/gfs/vc3vc3z_k", snapnum2, xmin, xmax, bins, linecolor= 50, /xrwt
...
if (linecolor ne 150) and (linecolor ne 50) then begin
	oplot, rs, ent_pro, psym=-3, linestyle=0, color= linecolor, thick=3.0
endif
...
if (linecolor ne 150) and (linecolor ne 50) then begin
	oplot, rs, ct_pro, psym=-3, linestyle=0, color= linecolor, thick=3.0
endif
...
if (linecolor ne 150) and (linecolor ne 50) then begin
	oplot, rs, rho_pro, psym=-3, linestyle=0, color= linecolor, thick=3.0
endif
