...
timelbl= ['-5 Gyr', '-4 Gyr', '-2 Gyr', '-1 Gyr', 'Today', '+1 Gyr', $
	  '+2 Gyr', '+3 Gyr', '+4 Gyr', '+5 Gyr', '+6 Gyr', '+10 Gyr']
;timelbl(*)= ' '
;timelbl(*)= ' '



filename=frun+'/panelfig_stars.eps'
...
;--------------------------------------
	...
	do_panel, frun, snaparr[0], xlenarr[0], x0, y3, xs, ys, $
		rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[0], /colorbar
	do_panel, frun, snaparr[1], xlenarr[1], x1, y3, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[1]
	do_panel, frun, snaparr[2], xlenarr[2], x2, y3, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[2]
	do_panel, frun, snaparr[3], xlenarr[3], x0, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[3]
	do_panel, frun, snaparr[4], xlenarr[4], x1, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[4]
	do_panel, frun, snaparr[5], xlenarr[5], x2, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[5]
	do_panel, frun, snaparr[6], xlenarr[6], x0, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[6]
	do_panel, frun, snaparr[7], xlenarr[7], x1, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[7]
	do_panel, frun, snaparr[8], xlenarr[8], x2, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta, tlbl=timelbl[8]
...
pro do_panel, frun, snapnum, xlen, $
	...
	;snaplbl= '('+strcompress(string(snapnum),/remove_all)+')'
		...
		if keyword_set(drawcenters) then begin
			...
			oplot, cp_cen1_x, cp_cen1_y, psym=-3, linestyle=0, color= 50, thick=4.0
			oplot, cp_cen2_x, cp_cen2_y, psym=-3, linestyle=0, color= 50, thick=4.0
