...
;
;===============================================
pro lg_contour_add_idlist, idlistfilename, center=center, $
...
orig_center= center
		...
		;
			...
			fload_newcolortable, 4
                        ...
                        ; oldstars
                        ; ----------
                        x= fload_oldstars_xyz('x',center=center)
                        y= fload_oldstars_xyz('y',center=center)
        ...
        ; -----
				...
				print, lstid, idlist_fmfile[i]
                        ...
                        ;if midx(0) ne -1 then oplot, x(midx), y(midx), psym=3, color= 150 
