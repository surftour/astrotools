...
if not keyword_set(junk) then begin
   print, "  "
   print, "gmass, junk, filename=filename, /h, "
...
if keyword_set(gasmass) then if not keyword_set(filename) then filename='gmass.eps'
...
process_one_sfr, "z3/b5v4e", lcolor=200, lthick= 2.0, msg='z3/b5v4e', x0= 0.20, y0= 0.36, gasmass=gasmass
process_one_sfr, "z3/b5v4ea", lcolor=230, lthick= 2.0, msg='z3/b5v4ea', x0= 0.70, y0= 0.75, gasmass=gasmass
process_one_sfr, "z3/b5v11e", lcolor=180, lthick= 2.0, msg='z3/b5v11e', x0= 0.20, y0= 0.33, gasmass=gasmass
process_one_sfr, "z3/b5v11ea", lcolor=160, lthick= 2.0, msg='z3/b5v11ea', x0= 0.20, y0= 0.30, gasmass=gasmass
process_one_sfr, "z3/b5v13e", lcolor=140, lthick= 2.0, msg='z3/b5v13e', x0= 0.20, y0= 0.27, gasmass=gasmass
process_one_sfr, "z3/b5v14e", lcolor=120, lthick= 2.0, msg='z3/b5v14e', x0= 0.20, y0= 0.24, gasmass=gasmass
;--------------
