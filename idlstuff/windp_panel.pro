...
;frun= "/raid4/tcox/vc3vc3e_2"  & filename= 'panelfig_e_contrast.eps'
...
;frun= "/raid4/tcox/vc3vc3h_2"  & filename= 'panelfig_h.eps'
...
;--------------------------------------
	...
	do_panel, frun, snap1, xlen, x0, y3, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap2, xlen, x1, y3, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap3, xlen, x2, y3, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap4, xlen, x0, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap5, xlen, x1, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap6, xlen, x2, y2, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap7, xlen, x0, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap8, xlen, x1, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap9, xlen, x2, y1, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap10, xlen, x0, y0, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	do_panel, frun, snap11, xlen, x1, y0, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
	;do_panel, frun, snap12, xlen, x2, y0, xs, ys, $
	;	rotate_phi=rotate_phi, rotate_theta=rotate_theta, /draw_circle
	do_panel, frun, snap12, xlen, x2, y0, xs, ys, rotate_phi=rotate_phi, rotate_theta=rotate_theta
