...
process_one_sfr, "hubble/SaSa_o1", lcolor=50, lthick= 2.0, msg='SbSb_o1', x0= 0.70, y0= 0.92
process_one_sfr, "hubble/SaSb_o1", lcolor=100, lthick= 2.0, msg='SbSc_o1', x0= 0.70, y0= 0.88
process_one_sfr, "hubble/SaSc_o1", lcolor=150, lthick= 2.0, msg='SbSd_o1', x0= 0.70, y0= 0.84
process_one_sfr, "hubble/SaSd_o1", lcolor=200, lthick= 2.0, msg='SbIm_o1', x0= 0.70, y0= 0.80
;process_one_sfr, "hubble/SaIm_o1", lcolor=0, lthick= 2.0, msg='SbIm_o1', x0= 0.70, y0= 0.76

; ---------------------------------------------------

;process_one_sfr, "hubble/SbSb_o1", lcolor=50, lthick= 2.0, msg='SbSb_o1', x0= 0.70, y0= 0.92
;process_one_sfr, "hubble/SbSc_o1", lcolor=100, lthick= 2.0, msg='SbSc_o1', x0= 0.70, y0= 0.88
;process_one_sfr, "hubble/SbSd_o1", lcolor=150, lthick= 2.0, msg='SbSd_o1', x0= 0.70, y0= 0.84
;process_one_sfr, "hubble/SbIm_o1", lcolor=200, lthick= 2.0, msg='SbIm_o1', x0= 0.70, y0= 0.80

; ---------------------------------------------------

;process_one_sfr, "hubble/ScSc_o1", lcolor=100, lthick= 2.0, msg='ScSc_o1', x0= 0.70, y0= 0.88
;process_one_sfr, "hubble/ScSd_o1", lcolor=150, lthick= 2.0, msg='ScSd_o1', x0= 0.70, y0= 0.84
;process_one_sfr, "hubble/ScIm_o1", lcolor=200, lthick= 2.0, msg='ScIm_o1', x0= 0.70, y0= 0.80

; ---------------------------------------------------

;process_one_sfr, "hubble/SdSd_o1", lcolor=150, lthick= 2.0, msg='SdSd_o1', x0= 0.70, y0= 0.84
;process_one_sfr, "hubble/SdIm_o1", lcolor=200, lthick= 2.0, msg='SdIm_o1', x0= 0.70, y0= 0.80

; ---------------------------------------------------

;process_one_sfr, "hubble/ImIm_o1", lcolor=200, lthick= 2.0, msg='ImIm_o1', x0= 0.70, y0= 0.80
