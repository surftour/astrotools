...
if do_Is eq 1 then begin
	...
	; N= 2
	xyouts, 0.25, 0.85, '!6N= 2.0', color= 150, charthick=4.0, size=1.50, /normal

	;load_and_plot, '/raid4/tcox/isolated/d3_N2', snapnum, plotcolor=150, plotthick=4.0;, pstyle= 5
	;xyouts, 0.42, 0.85, '(d3_N2)', color= 150, charthick=2.0, size=1.10, /normal
	;load_and_plot, '/raid4/tcox/isolated/d3_N2a', snapnum, plotcolor=150, plotthick=4.0;, pstyle= 5
	;load_and_plot, '/raid4/tcox/isolated/d3_N2b', snapnum, plotcolor=150, plotthick=4.0;, pstyle= 5
	load_and_plot, '/raid4/tcox/isolated/d3_N2c', snapnum, plotcolor=150, plotthick=4.0;, pstyle= 5
	xyouts, 0.42, 0.85, '(d3_N2c)', color= 150, charthick=2.0, size=1.10, /normal



	; N= 1.5
	xyouts, 0.25, 0.80, '!6N= 1.5', color= 100, charthick=4.0, size=1.50, /normal

	;load_and_plot, '/raid4/tcox/isolated/d3', snapnum, plotcolor=100, plotthick=4.0;, pstyle= 5
	load_and_plot, '/raid4/tcox/isolated/d3_N1.5', snapnum, plotcolor=100, plotthick=4.0;, pstyle= 5
	xyouts, 0.42, 0.80, '(d3_N1.5)', color= 100, charthick=2.0, size=1.10, /normal



	; n= 1
	xyouts, 0.25, 0.75, '!6N= 1.0', color= 50, charthick=4.0, size=1.50, /normal

	;load_and_plot, '/raid4/tcox/isolated/d3_N0', snapnum, plotcolor=50, plotthick=4.0;, pstyle= 2
	;xyouts, 0.42, 0.75, '(d3_N0)', color= 50, charthick=2.0, size=1.10, /normal
	;load_and_plot, '/raid4/tcox/isolated/d3_N0a', snapnum, plotcolor=50, plotthick=4.0;, pstyle= 2
	;load_and_plot, '/raid4/tcox/isolated/d3_N0b', snapnum, plotcolor=50, plotthick=4.0;, pstyle= 2
	load_and_plot, '/raid4/tcox/isolated/d3_N0c', snapnum, plotcolor=50, plotthick=4.0;, pstyle= 2
	xyouts, 0.42, 0.75, '(d3_N0c)', color= 50, charthick=2.0, size=1.10, /normal
